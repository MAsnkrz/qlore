...
BRAND_URL       = "https://www.qogita.com/brands/loreal/"
...
def fetch_maybelline_variants_from_page(context):
    ...
    print("  Scraping L'Oréal brand pages for product list...")
    all_products = []
    page_num = 1
...
def run_check():
    ...
    baseline_done = os.path.exists("baseline_done_loreal.txt")
    ...
    if is_first_run:
        ...
        with open("baseline_done_loreal.txt", "w") as f:
...
def main():
    print("=" * 55)
    print("  Qogita L'Oréal Monitor (API-based)")
